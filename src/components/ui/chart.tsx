        ...
        {payload
          ...
          .map((item, index) => {
            ...
            const indicatorColor =
              color ??
              getStringPayloadValue(item.payload, "fill") ??
...
function getPayloadConfigFromPayload(
  ...
  const payloadValue = getStringPayloadValue(payload, key);
  const nestedPayloadValue = getStringPayloadValue(payloadPayload, key);

  if (payloadValue) {
    configLabelKey = payloadValue;
  } else if (nestedPayloadValue) {
